...
export const Intro= ()=>{
    return <div className="w-72 h-[50rem] mb-0 pt-14 z-1 top-14 bg-eerie-black rounded-3xl flex flex-col justify-center items-center sticky">

        <div className='flex flex-col justify-center items-center p-0'>
            <div className='bg-gradient-to-t from-[#303030] from-5% to-[#3f3f40] to-95% h-[150px] w-[150px] rounded-3xl justify-center items-center'>
            ...
            <div className='h-[120px] w-[150px] mt-6 mb-0'>
                ...
                <div className='h-[28px] w-[150px] mt-3.5 mb-0 text-white bg-[#2b2b2c] rounded-lg text-xs font-light flex justify-center items-center'>
                    Software Devloper
                </div>
            </div>
        </div>
